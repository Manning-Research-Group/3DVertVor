...
bool container_base::put_locate_block(int &ijk,double &x,double &y,double &z) {
    ...
    //DEBUG
//    if((ijk<0) || (ijk>=nxyz)) {
//      fprintf(stderr,"voro::container_base::put_locate_block: nx=%d, ny=%d, nz=%d\n",nx,ny,nz);
//      fprintf(stderr,"voro::container_base::put_locate_block: x=%g,  y=%g,  z=%g; (boxx=%g, 1/xsp=%g)\n",x,y,z,boxx, 1.0/xsp);
//      fprintf(stderr,"voro::container_base::put_locate_block: ijk=%d; nxyz=%d\n",ijk,nxyz);      
//    }
